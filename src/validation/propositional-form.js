...
export class PropositionalForm {
    ...
    static conditional ( antecedent, consequent, catalog ) {
        ...
        const result = consequent instanceof PropositionalForm ?
        ...
        const premises = PropositionalForm.fromConclusionsIn(
    ...
    static fromConclusion ( conclusion, ancestor, catalog ) {
        return PropositionalForm.sequent(
            ...conclusion.accessibles( true, ancestor ), catalog )
    }
    ...
    // Does the text representation of this PropositionalForm object appear
    // in the given array?
    isIn ( array ) { return array.includes( this.text ) }

    // Yields the given array with this object's text representation added.
    // More specifically:  Given an array of text representations of
    // PropositionalForm objects, if this object's text representation is
    // already in the array, then return the array unchanged.  Otherwise
    // return a new array equal to the old, plus the new text appended.
    addedTo ( array ) {
        return this.isIn( array ) ? array : array.concat( [ this.text ] )
    }
