...
const putdownDatabase = [
  ...
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables X P)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(w (w X (@apply P X)) (forall x , (@apply P x)))  (w (w k (lt (plus k 1) 5)) (forall s , (lt (plus s 1) 5)))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tX  k\n\t\tP  (@lambda v , (lt (plus v 1) 5))\n\t)\n)\n"
  },
  {
  ...
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (gte 0 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall n , (implies (gte n 0) (gte (plus n 1) 0)))\n\t(forall n , (@apply P n))                                                   (forall n , (gte n 0))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tP  (@lambda v , (gte v 0))\n\t\tk  n\n\t\tn  n\n\t)\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (eq (plus 0 0) 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall m , (implies (eq (plus m 0) m) (eq (plus (plus m 1) 0) (plus m 1))))\n\t(forall n , (@apply P n))                                                   (forall k , (eq (plus k 0) k))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tP  (@lambda v , (eq (plus v 0) v))\n\t\tk  m\n\t\tn  k\n\t)\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (P 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall k , (implies (P k) (P (plus k 1))))\n\t(forall n , (@apply P n))                                                   (forall n , (P n))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tP  (@lambda v , (P v))\n\t\tk  k\n\t\tn  n\n\t)\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (eq 7 5)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall n , (implies (eq 7 5) (eq 7 5)))\n\t(forall n , (@apply P n))                                                   (forall n , (eq 7 5))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tP  (@lambda v , (eq 7 5))\n\t\tk  n\n\t\tn  n\n\t)\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (R n 1)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall m , (implies (R m 1) (R (plus m 1) 1)))\n\t(forall n , (@apply P n))                                                   (forall m , (R m 1))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t// no solutions\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (gte k 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall k , (implies (gte k k) (gte k (plus k 1))))\n\t(forall n , (@apply P n))                                                   (forall n , (gte n k))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t// no solutions\n)\n"
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (gte n 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall k , (implies (gte n k) (gte n (plus k 1))))\n\t(forall n , (@apply P n))                                                   (forall n , (gte n n))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t// no solutions\n)\n"
  },
  {
  ...
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables P k n)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(@apply P 0)                                                                (gte 0 0)\n\t(forall k , (implies (@apply P k) (SecondOrderMatchingMeta P (plus k 1))))  (forall n , (implies (gte n 0) (gte 0 (plus n 1))))\n\t(forall n , (@apply P n))                                                   (forall n , (gte 0 0))\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t// no solutions\n)\n"
  },
  {
  ...
  },
  {
    ...
    "content": "\n// This file was autogenerated as part of an export process from an old repository.\n\n// Declare the metavariables in this matching problem:\n(metavariables x P Q)\n\n// List the pattern-expression pairs in this matching problem:\n(problem\n\t(exists x , (@apply P x))              (exists m , (gt m 0))\n\t(forall x , (implies (@apply P x) Q))  (forall n , (implies (gt n 0) (gt -1 0)))\n\tQ                                      (gt -1 0)\n)\n\n// List all solutions in this matching problem:\n(solutions\n\t( // solution 1\n\t\tx  m\n\t\tP  (@lambda v , (gt v 0))\n\t\tQ  (gt -1 0)\n\t)\n)\n"
  },
  {
